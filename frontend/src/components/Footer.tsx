        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div className="lg:col-span-1">
            ...
            <p className="text-neutral-400 mb-6 leading-relaxed">
              {language === 'ar' 
                ? 'خدمات التدقيق والمحاسبة والاستشارات المالية بأعلى معايير الاحترافية والنزاهة'
                : 'Auditing, Accounting & Financial Consulting with the highest standards of professionalism and integrity'}
            </p>
            {/* Social Links */}
              ...
              {settings.contact_address && (
                <li className="flex items-start space-x-3 rtl:space-x-reverse">
                  ...
                  <span className="text-neutral-400">
                    {language === 'ar' ? settings.contact_address_ar : settings.contact_address}
                  </span>
                </li>
              )}
              {/* Phone Numbers */}
        ...
        <div className="container-custom py-6">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            <p className="text-neutral-500 text-sm">
              © {currentYear} {language === 'ar' ? 'النخبة المتحدة' : 'The United Elite'}.{' '}
